...
//MELHORIA: Quero um modal que seja uma 'função' que retorna verdadeiro (se clica no OK) e falso se outra coisa
function addConfirm(tipo, callback){
